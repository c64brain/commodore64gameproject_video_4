...
;
; File: Project 4: Move Sprite around the Map
;===============================================================================
;===============================================================================
...
Setup_Map
        ...
        ldx #0                        ; Y start pos (in tile coords) (129,26=default)
...
incbin"Parkour_Maps2/Parkour_Chset2e.bin"
...
incbin "yoursprite.spt",1,6,true        ; idle (28,33)
...
incbin "yoursprite.spt",29,34,true       ; Punching to the left
...
incbin "yoursprite.spt",45,46,true       ; Standing idle
incbin "yoursprite.spt",56,62,true
...
MAP_MEM
incbin"Parkour_Maps2/Parkour_Map2e.bin"


ATTRIBUTE_MEM
incbin"Parkour_Maps2/Parkour_ChsetAttrib2e.bin"

TILE_MEM
incbin"Parkour_Maps2/Parkour_Tileset2e.bin"
